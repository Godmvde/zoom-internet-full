    ...
    <>
          ...
          <div>
            <Reveal delay={80}>
              <h1 className="display not-italic font-bold text-[2.7rem] sm:text-[3.6rem] lg:text-[4.2rem] text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.35)]">
                Where Speed Meets{" "}
                <span className="text-blue-grad">Reliability.</span>
              </h1>
            </Reveal>
            <Reveal delay={150}>
              <p className="mt-6 max-w-xl text-lg text-white/80 leading-relaxed">
                High-speed wireless internet engineered for homes and businesses.
              </p>
            </Reveal>
            <Reveal delay={220}>
            ...
            <Reveal delay={300}>
              <div className="flex flex-wrap items-center gap-x-6 gap-y-3 mt-8 text-sm text-white/90">
                {["Unlimited data", "Zero contracts", "Reliable connectivity"].map((t) => (
      ...
      <section className="bg-[var(--color-mist)] border-y border-[var(--color-line)]">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-24">
          <div className="text-center max-w-2xl mx-auto">
            <Reveal><span className="eyebrow">Plans &amp; pricing</span></Reveal>
            <Reveal delay={80}>
              <h2 className="display text-3xl sm:text-[2.6rem] text-[var(--color-heading)] mt-3">
      ...
      <section className="bg-[var(--color-navy)] text-white overflow-hidden relative">
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8 py-24">
          <div className="max-w-2xl">
            <Reveal><span className="eyebrow !text-[var(--color-cyan)]">How it works</span></Reveal>
            <Reveal delay={80}>
              <h2 className="display text-3xl sm:text-[2.6rem] mt-3">
                From sign-up to streaming in four easy steps.
              </h2>
            </Reveal>
          </div>
            ...
            {steps.map((s, i) => (
              <Reveal key={s.n} delay={i * 90}>
                <div className="relative">
                  ...
                  <h3 className="display text-xl mt-2">{s.title}</h3>
                  <p className="text-white/65 text-sm mt-2 leading-relaxed">{s.text}</p>
                  {i < steps.length - 1 && (
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 py-24">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <Reveal delay={80}>
            <h2 className="display text-3xl sm:text-[2.6rem] text-[var(--color-heading)] mt-3">
              Check coverage &amp; test your speed
            </h2>
          </Reveal>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 py-24">
        <div className="max-w-2xl">
          <Reveal><span className="eyebrow">Why Zoom</span></Reveal>
          <Reveal delay={80}>
            <h2 className="display text-3xl sm:text-[2.6rem] text-[var(--color-heading)] mt-3">
              Built for how Jamaica actually uses the internet.
            </h2>
          </Reveal>
        </div>
            ...
            return (
              <Reveal key={f.title} delay={i * 80}>
                <div className="card card-hover h-full p-7">
                  ...
                  <h3 className="display text-xl text-[var(--color-heading)] mt-5">{f.title}</h3>
                  <p className="text-[var(--color-slate)] text-sm mt-2 leading-relaxed">{f.text}</p>
                </div>
              </Reveal>
            );
          })}
      ...
      <section className="bg-[var(--color-mist)] border-y border-[var(--color-line)]">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-24">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <Reveal><span className="eyebrow">Loved across Mobay</span></Reveal>
            <Reveal delay={80}>
              <h2 className="display text-3xl sm:text-[2.6rem] text-[var(--color-heading)] mt-3">
      ...
      <section className="px-5 sm:px-8 pb-24">
        <div className="max-w-6xl mx-auto rounded-[2rem] bg-gradient-to-br from-[var(--color-zoom-bright)] via-[var(--color-zoom)] to-[var(--color-zoom-deep)] text-white p-10 sm:p-16 text-center relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <h2 className="display text-3xl sm:text-[2.8rem]">Ready to zoom?</h2>
            <p className="text-white/85 mt-4 max-w-xl mx-auto text-lg">
              Join your neighbours across Montego Bay enjoying fast, unlimited internet.
              Get connected today.
            </p>
            <div className="flex flex-wrap gap-3 justify-center mt-8">
              ...
              <a href={`tel:${company.phoneHref}`} className="btn !bg-white/15 !text-white border border-white/30 hover:!bg-white/25">
                Call {company.phone}
              </a>
            </div>
          </div>
  ...
  return (
    <div className="relative w-full max-w-[460px] mx-auto h-[460px]">
      ...
      <div className="glass-card absolute top-2 -left-2 float-slow rounded-2xl p-5 w-[200px]">
        <div className="text-xs text-white/60 uppercase tracking-wider">Live download</div>
      ...
      <div className="glass-card absolute bottom-4 right-0 float-slow rounded-2xl px-5 py-4" style={{ animationDelay: "1.5s" }}>
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold text-white text-sm">Unlimited data</div>
            <div className="text-xs text-white/60">No caps, ever</div>
          </div>
        </div>
      </div>
